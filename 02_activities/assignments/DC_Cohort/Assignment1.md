...
```
I am a PhD candidate in Health Systems Research (within the Dalla Lana School of Public Health), which often involves collaborating with individuals who develop and use patient information databases for research and clinical practice. The types of databases that I encounter value efficiency over equity, and are particularly rigid. For example, I’ve personally seen inequalities and social structures embedded in the way demographic characteristics are collected. This was particularly challenging during the start of COVID-19 where sociodemographic data was not systematically collected. It was known in scientific literature that certain marginalized and racialized populations were more impacted by the pandemic than other groups. Leadership from the Black Health Equity Working Group (consisting of individuals from Black communities, academics, service providers and policy specialists) developed ways for sociodemographic data to be collected and used intentionally by the City of Toronto, the Province of Ontario and the Federal government. As a result, the City of Toronto found that racialized populations had higher rates of COVID-19 cases and hospitalization, leading to changes in the public health response to improve equity during the COVID-19 vaccine roll-out. Further, I often find that when we report our gender or race in patient information databases, they have been restricted to outdated norms (e.g., only Female and Male options). For example, I am South Asian, but I find that in certain databases, I often have to label myself as ‘Asian’, which is not entirely accurate, especially given the diversity across the countries within Asia. I think health researchers are doing a better job at providing more nuance in the databases that store and patient sociodemographic data, but it is not consistent. I do believe data stewardship and leadership needs to come from the Federal government to allow for flexibility in their databases, or like the article described, providing opportunities to think ahead and plan for data types and inquiries that are flexible and open societal understanding of identity and equity deepens.
```
